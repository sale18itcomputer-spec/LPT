...
const RevenueTrendChart: React.FC<RevenueTrendChartProps> = ({ data }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col" aria-label={`Revenue trend by ${granularity}`} role="figure" tabIndex={0}>
...
const MemoizedRevenueTrendChart = React.memo(RevenueTrendChart);
MemoizedRevenueTrendChart.displayName = 'RevenueTrendChart';
export default MemoizedRevenueTrendChart;
