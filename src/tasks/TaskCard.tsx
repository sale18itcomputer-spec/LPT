...
const TaskCard: React.FC<TaskCardProps> = ({ task, isDragging, onClick, handleDragStart }) => {
    ...
    return (
        <motion.div
            ...
            data-task-card="true"
            className="w-full bg-secondary-bg dark:bg-dark-secondary-bg rounded-lg border border-border-color dark:border-dark-border-color cursor-pointer active:cursor-grabbing focus-visible:ring-2 focus-visible:ring-highlight focus-visible:outline-none overflow-hidden min-h-[6rem] flex flex-row"
            style={{
            ...
            onClick={onClick}
        >
            <div className={`w-1.5 flex-shrink-0 ${priorityClasses.bar}`} title={`Priority: ${priority}`}></div>
            ...
            <div className="flex-1 p-3 flex flex-col min-w-0">
                ...
                <div className="flex justify-between items-center mt-auto pt-3 text-xs text-secondary-text dark:text-dark-secondary-text">
